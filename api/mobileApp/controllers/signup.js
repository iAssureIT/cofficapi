...
// exports.user_createcustomer = (req,res,next)=>{
//     Signup.find()
//         .exec()
//         .then(user =>{              
//                 bcrypt.hash(req.body.pwd,10,(err,hash)=>{
...
//     Signup.findOne({'mobileNumber':req.body.mobileNumber})
//         .exec()
//         .then((user)=>{
...
//     Signup.find({'mobileNumber':req.body.mobileNumber})
//         .limit(1)
//         .exec()
//         .then(user =>{
...
//     Signup.findOne({emails:{$elemMatch:{address:req.body.email}}})
//         .exec()
//         .then(user => {
//             if(user){
//                 var pwd = user.services.password.bcrypt;
...
//     Signup.findOne({_id:req.params.userID})
//         .exec()
//         .then(user=>{
//             if(user){
...
//     Signup.findOne({roles: req.body.roles})
//         .exec()
//         .then(data =>{
//             if(data){
//                 return res.status(200).json({
...
//     Signup.findOne({emails:{$elemMatch:{address:req.body.emailId}}})
//         .exec()
//         .then(user => {
//             if(user){
//                 bcrypt.hash(req.body.pwd,10,(err,hash)=>{
